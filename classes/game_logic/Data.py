...
class Data:
    ...
    def __init__(self):
        ...
        self.lemonShop_inc = Inc("Lemon Shop", 5, 1, 1, 1, 1,LEMON_IMG)
        self.paper_inc = Inc("News Paper Shop", 10, 2, 2, 2, 2,PAPER_IMG)
        self.car_wash_inc = Inc("Car Wash", 15, 3, 3, 2, 3,CAR_IMG)
        self.pizza_inc = Inc("Pizza", 20, 4, 4, 4, 4, PIZZA_IMG)
